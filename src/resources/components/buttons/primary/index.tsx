...
const PrimaryButton = ({
  ...
  <div>
    <button
      ...
      className={` group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm bg-grayish-violet-900 font-medium rounded-md text-white 
      focus:outline-none`}
      onClick={onClick}
    >
      <>
